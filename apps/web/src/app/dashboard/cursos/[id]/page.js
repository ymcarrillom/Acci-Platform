      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/55 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative p-7">
          ...
          <div className="mt-5 flex items-center gap-3 flex-wrap">
            {role === 'ADMIN' && <CourseActions courseId={course.id} isActive={course.isActive} />}
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/55 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative p-7">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-extrabold text-white">Actividades ({activities.length})</h2>
            {(role === 'TEACHER' || role === 'ADMIN') && (
              <Link
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/55 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative p-7">
          <h2 className="text-lg font-extrabold text-white mb-4">
            {role === 'STUDENT' ? 'Clases por Recuperar' : 'Clases de Recuperación'} (
            {recoveryVideos.length})
          </h2>
