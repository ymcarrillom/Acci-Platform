    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              <option value="TASK" className="bg-slate-900 text-white">Tarea</option>
              <option value="MATERIAL" className="bg-slate-900 text-white">Material</option>
            </select>
          </div>
          ...
          {form.type === "QUIZ" && (
            <>
              <div>
                <label className="block text-xs font-semibold text-slate-400 mb-1">Tiempo límite (minutos)</label>
                <input
                  type="number"
                  min="1"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-400 mb-1">Número de intentos</label>
                <input
                  type="number"
                  min="0"
          ...
          {form.type === "MATERIAL" && (
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-1">Documento adjunto</label>
              <input
                type="file"
              ...
              {initial?.fileUrl && !file && (
                <p className="text-xs text-emerald-400 mt-1">Archivo actual: {initial.fileUrl.split("/").pop()}</p>
              )}
            </div>
          )}
      ...
      <div className="flex items-center gap-3">
        ...
        {(form.type !== "QUIZ" || step === 2) && (
          ...
          >
            {uploading ? "Subiendo archivo..." : saving ? "Guardando..." : isEdit ? "Guardar cambios" : "Crear actividad"}
          </button>
        )}
