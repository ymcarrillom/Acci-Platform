...
router.post("/", authRequired, requireRole("STUDENT"), verifyCourseAccess, async (req, res, next) => {
  try {
    const { courseId } = req.params;
...
router.put("/:id", authRequired, requireRole("STUDENT"), verifyCourseAccess, async (req, res, next) => {
  try {
    const { id } = req.params;
...
router.delete("/:id", authRequired, requireRole("STUDENT"), verifyCourseAccess, async (req, res, next) => {
  try {
    const { id } = req.params;
